...
![](img/cellphone_ban_florida.jpeg){height="30%" fig-align="center"}
...
![](img/dynarski_computer_class.png){height="60%" fig-align="center"}
...
![](img/ednext_XVII_4_carter_fig02-small.jpg){height="30%" fig-align="center"}
...
## A quick word about in-class technology and learning {.pause}

- I'm not saying you should *not* use your laptop/tablet in class $\rightarrow$ we need them to do the in-class tasks!

- I want to nudge you to use it [wisely]{.hi_purple}

. . .

- Listen, ask questions, and look at the board rather than your screen

- When doing `R` tasks try to focus on the task at hand
...
$\rightarrow$ to summarize these data, the World Inequality Report uses **quantiles**
...
$\rightarrow$ to summarize this information, OWD uses **statistical measures of evolution**

## Forecasting election results

![](img/us_elections.png){width="450" fig-align="center"}
...
<p style = "margin-bottom: -2.8cm;"></p>

$\rightarrow$ the following statistical tools are used: **mean**, standard deviation, normal distribution, **confidence intervals**
...
::: {.incremental}
1. [Free]{.hi_blue} and [open source]{.hi_blue}: saves both you and the university 💸.
...
**Observation:** _set of measurements made under similar conditions. An observation will contain several values, each associated with a different variable. We’ll sometimes refer to an observation as a data point._
:::
...
$\rightarrow$ Let's build the graph [together]{.hi_purple}
...
- Analyze real-world data of your choice to understand a specific question
...
- Specific guidelines coming soon 🙂
...
- on [Github](https://github.com/gustavekenedi/L2-Statistics?tab=readme-ov-file#slides) and on Moodle (soon!)
...
[6. Course details](#course_details) $\checkmark$
